...
# ── Watchlist ──────────────────────────────────────────────────────────────────
# Permanent investment-grade items. Always shown; never filtered out.
WATCHLIST = [
...
# ── Signals Universe ───────────────────────────────────────────────────────────
# Items whose price is primarily driven by out-of-game factors:
# game updates, dev blogs, hype cycles, meta shifts, community discussion.
# The context string is your "why to watch" note — update it when circumstances change.
# Format: "item name": "signal type | date | detail"
# e.g.   "OSRS Blog Jun-12 | Soulreaper axe buffed in Raids 4 rework"
SIGNALS_UNIVERSE = {
...
def compute_flips(latest, mapping, hour_vols, fmin_vols):
    ...
    # Watchlist: always include every defined item present in market data
    ...
    # Signals: always include every defined item present in market data
